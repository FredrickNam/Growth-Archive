...
Welcome to my **Growth Archive**.
The purpose of this repository is to track my study progress and manage the source codes I have written.
...
* **Clarifying** my fields of interest and defining my specific area of study
...
| :---: | :--- | :---: | :---: | :---: |
| 📘 **Book** | **DeepLearningFromScratch1(KokiSaitoh)** | 🏃 In Progress | [Go to Folder](DeepLearningFromScratch-KokiSaitoh) | Kor |
